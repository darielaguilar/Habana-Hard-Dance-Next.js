    ...
    return(<div className=" flex-1 md:mx-10 mx-2 ">
        <Carousel className="border rounded-lg " activeIndex={index} onSelect={handleSelect}>
            <Carousel.Item className="flex w-100 h-72 sm:h-80">
                <img  className="flex w-100 h-72 sm:h-80 "  src='/dj-mixing.jpg' alt="First Slide"/>
                <Carousel.Caption>
                    <h3>Sueña</h3>
            ...
            <Carousel.Item className="flex w-100 h-72 sm:h-80">
                <img  className="flex w-100 h-72 sm:h-80 "  src='/hitsTrance.png' alt="Second Slide"/>
                <Carousel.Caption>
            ...
            <Carousel.Item className="flex w-100 h-72 sm:h-80">
                <img className="flex w-100 h-72 sm:h-80 "  src='/tranceLight.jpg'  alt="Third Slide"/>
                <Carousel.Caption>
                    <h3>Crea</h3>
